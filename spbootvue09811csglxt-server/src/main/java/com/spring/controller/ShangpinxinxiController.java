...
public class ShangpinxinxiController extends BaseController {
    ...
    public String insert() {
        ...
        post.setShangpintupian(Request.get("shangpintupian"));
        ...
        post.setShangpinxiangqing(Info.download(Request.get("shangpinxiangqing")));

        service.insert(post); // 插入数据
        int charuid = post.getId().intValue();
        Query.execute("UPDATE shangpinxinxi SET shangpinjiage=(jinhuojiage*1.1) WHERE id='" + charuid + "'");
    ...
    public String update() {
        ...
        if (!Request.get("shangpintupian").equals("")) post.setShangpintupian(Request.get("shangpintupian"));
        ...
        if (!Request.get("shangpinkucun").equals("")) post.setShangpinkucun(Request.getInt("shangpinkucun"));
        if (!Request.get("shangpinxiangqing").equals("")) post.setShangpinxiangqing(Info.download(Request.get("shangpinxiangqing")));

        post.setId(Request.getInt("id"));
        service.update(post); // 更新数据
        int charuid = post.getId().intValue();
        Query.execute("UPDATE shangpinxinxi SET shangpinjiage=(jinhuojiage*1.1) WHERE id='" + request.getParameter("id") + "'");
    ...
    public String delete() {
        ...
        Map map = Query.make("shangpinxinxi").find(id);
