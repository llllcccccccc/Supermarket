<template>
    <div class="xiaoshou-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-number">
                <div class="detail-title">销售数量：</div>
                <div class="detail-content">{{ map.xiaoshoushuliang }}</div>
            </div>
            <div class="detail detail-textarea">
                <div class="detail-title">销售备注：</div>
                <div class="detail-content">{{ map.xiaoshoubeizhu }}</div>
            </div>
