<template>
    <div class="gongyingshang-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-longtext">
                <div class="detail-title">供应商地址：</div>
                <div class="detail-content">{{ map.gongyingshangdizhi }}</div>
            </div>
            <div class="detail detail-textarea">
                <div class="detail-title">供应商详情：</div>
                <div class="detail-content">{{ map.gongyingshangxiangqing }}</div>
            </div>
        </div>
        <div class="mt10">
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                ...
                this.loading = true;
                this.$get(api.gongyingshang.detail, {
                    id: this.id,
                })
                    .then((res) => {
                        this.loading = false;
